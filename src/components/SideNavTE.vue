...
<template>
  ...
  <nav
    ...
    <ul v-for="item in menuItems" :key="item.label" class="relative m-0 list-none px-[0.2rem]" data-te-sidenav-menu-ref>

      <li v-if="item.subMenus && item.subMenus.length > 0" class="relative">
        <a
